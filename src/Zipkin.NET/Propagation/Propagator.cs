...
{
    /// <summary>
    /// Propagators are used to pass span context between applications.
    /// </summary>
    ...
    {
        public TInject Propagate(TInject inject, SpanContext spanContext)
        {
            ...
            return Inject(inject, spanContext);
        }
        ...
        /// </returns>
        protected abstract TInject Inject(TInject inject, SpanContext spanContext);
    }
}
